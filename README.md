...
pixi add alfasim-sdk
# for installing globally
pixi global install alfasim-sdk
```
...
It is possible to list all of the versions of `alfasim-sdk` available on your platform:
...
```
pixi search alfasim-sdk --channel conda-forge
```
